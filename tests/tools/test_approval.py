...
class TestSensitiveCopyMovePattern:
    ...
    def test_cp_from_ssh_flagged_by_read_floor(self):
        # Upstream asserted this was safe (only writes INTO cred dirs were
        # flagged). The fork's L2 read-floor (glocal: shell reads/copies of
        # credential material route through approval) intentionally flags
        # copies OUT of ~/.ssh as well — fork semantics win here.
