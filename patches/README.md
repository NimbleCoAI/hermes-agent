...
[Swarm Map](https://github.com/NimbleCoOrg/swarm-map) integration plugin for group access control. Uses standard plugin hooks — no core code changes.
...
- [Swarm Map](https://github.com/NimbleCoOrg/swarm-map) — Admin GUI for managing Hermes agents
